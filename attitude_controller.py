...
class Edrone():
    ...
    def pid(self):
        ...
        self.pwm_cmd.prop1 = max(min(pwmthrottleout + self.output[0] - self.output[1] - self.output[2], 1023), 1)
        self.pwm_cmd.prop2 = max(min(pwmthrottleout - self.output[0] - self.output[1] + self.output[2], 1023), 1)
        self.pwm_cmd.prop3 = max(min(pwmthrottleout - self.output[0] + self.output[1] - self.output[2], 1023), 1)
        self.pwm_cmd.prop4 = max(min(pwmthrottleout + self.output[0] + self.output[1] + self.output[2], 1023), 1)
